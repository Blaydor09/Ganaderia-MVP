    ...
    <>
      ...
      <div
        className={cn(
          ...
          isLocked ? "pointer-events-none translate-y-10 opacity-0" : "translate-y-0 opacity-100"
        )}
      >
        <button
          onClick={() => setIsLocked(true)}
          className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-900 text-white shadow-lg transition-transform hover:scale-105 hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200"
