  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 bg-white px-6 py-4 dark:border-slate-800 dark:bg-slate-950/80">
      ...
      <div className="flex items-center gap-3">
        <button
          type="button"
          className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 text-slate-500 hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
        ...
        <div className="flex items-center gap-2 rounded-full border border-slate-200 px-3 py-2 text-sm dark:border-slate-700">
          ...
          <div className="leading-tight">
            <div className="text-slate-700 dark:text-slate-200">{me?.name ?? "Usuario"}</div>
            <div className="text-xs text-slate-500 dark:text-slate-400">{me?.tenant?.name ?? "Cuenta"}</div>
          </div>
        </div>
