...
const DashboardLayout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <ThemeShell className="relative flex min-h-screen text-slate-900 dark:text-slate-100">
      <Sidebar
      ...
      />
      <div className="flex flex-1 flex-col min-w-0 transition-all duration-700">
        <Topbar
